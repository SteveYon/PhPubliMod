<?php
	...
	check_login($bd);
        ...
        $title          = substr(addSlashes($_POST['TITLE']), 1, strlen(addSlashes($_POST['TITLE']))-2);
        $year           = $_POST['YEAR'];
	...
	$url            = $_POST['URL'];
	$abstract       = substr(addSlashes($_POST['ABSTRACT']), 1, strlen(addSlashes($_POST['ABSTRACT']))-2);
